...
with open('/home/kj/skjsurrol/SurRoL_skj/tests/record/demo_record_needle_reach_demo_plot4.pkl', 'rb') as f:
...
traj = np.load('/home/kj/skjsurrol/SurRoL_skj/tests/absolute_needle_reach_position.npy')

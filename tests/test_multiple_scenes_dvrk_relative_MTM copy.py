...
class SurgicalSimulator(SurgicalSimulatorBase):
    ...
    def MTM_move_to_position(self, target, step_num = 10):
        ...
        #     mat = np.eye(4)
        #     self.MTMR2PSM(retrived_action,mat)
        #     self.env._set_action(retrived_action,mat)

        # else:
        #     self.MTMR2PSM(retrived_action)
        #     self.env._set_action(retrived_action)
        ...
        '''
        # move_to_target_forcebased(self.mr, target)
        # distance = 1
        # while distance > 1e-5:
